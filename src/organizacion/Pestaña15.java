...
public class Pestaña15 extends JPanel {
    ...
    private void jbInit() throws Exception {
        ...
        this.setLayout( null );
        jLabel1.setText("XV. ACREDITACION");
        ...
        jLabel2.setBounds(new Rectangle(140, 35, 85, 15));
        jLabel2.setForeground(Color.white);

        jScrollPane1.setBounds(new Rectangle(20, 60, 345, 315));
        jScrollPane1.getViewport().add(jTextArea1, null);
        
        jLabel3.setText("EVIDENCIAS");
    ...
    public boolean Guardar15()//Modulo que valida si los campos estan vacios by Emmanuel Cárdenas Salinas
        {
            boolean ind1,ind2;
            ...
            if(!(ind1==true&&ind2==true)){
                ...
                JOptionPane.showMessageDialog(this,"Faltan Campos Por llenar", "Error: Seccion XV",JOptionPane.ERROR_MESSAGE);
                return false;
            }
        }
        public void Escribir15(){//Modulo de escritura de los campos de la pestaña 15 by Emmanuel Cárdenas Salinas
            ...
            try{
                ...
                escArc.print(regi1);   //aaaaaaaaaaaa
                escArc.print(";"); 
                regi2=jTextArea2.getText();
                escArc.print(regi2); //ssssssssssssssssssssssssss
                escArc.print(";");
                escArc.close();
            } catch (IOException f) {}
    }
